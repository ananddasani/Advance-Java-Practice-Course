...
public class Query {
    ...
    public static void executeSelectQuery() {
        ...
        Connection connection = MyConnector.makeConnection();
     ...
     */
    public static int executeInsertQuery(StudentsModel student) {
        ...
        try {
            ...
            //Create Statement
            PreparedStatement preparedStatement = connection.prepareStatement(Constants.INSERT_QUERY);
    ...
    /**
     * Method will Delete the Entry of Students in the DB Table whose id is passed by MainActivity
     *
    ...
    public static int executeDeleteQuery(int idToBeDeleted) {
        ...
        //Create Statement
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(Constants.DELETE_QUERY);
        ...
        try {
            switch (updateChoice) {
                case 1:
                    ...
                    PreparedStatement preparedStatement = connection.prepareStatement(Constants.UPDATE_FIRSTNAME_QUERY);
                ...
                case 2:
                    ...
                    PreparedStatement preparedStatement2 = connection.prepareStatement(Constants.UPDATE_LASTNAME_QUERY);
                ...
                case 5:
                    //Update City only
                    PreparedStatement preparedStatement5 = connection.prepareStatement(Constants.UPDATE_CITY_QUERY);
    ...
    public static int executeUpdateSingleIntDataQuery(int updateChoice, int newData, int idToBeUpdated) {
        ...
        try {
            switch (updateChoice) {
                case 3:
                    //Update Sem only
                    PreparedStatement preparedStatement3 = connection.prepareStatement(Constants.UPDATE_SEM_QUERY);
                ...
                case 4:
                    //Update Marks only
                    PreparedStatement preparedStatement4 = connection.prepareStatement(Constants.UPDATE_MARKS_QUERY);
    ...
    public static int executeUpdateAllDataQuery(StudentsModel student, int idToBeUpdated) {
        Connection connection = MyConnector.makeConnection();
        int rowAffected = 0;
        ...
        try {
            ...
            //Create Statement
            PreparedStatement preparedStatement = connection.prepareStatement(Constants.UPDATE_ALL_QUERY);
